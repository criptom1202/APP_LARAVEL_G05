...
<div {{ $attributes->merge(['class' => 'w-full']) }}>
    <nav>
        <ul>
            ...
            <li class="pl-10 py-3 hover:bg-red-800 font-bold flex flex-row"><div class="px-5"><i class="fa-solid fa-address-card"></i></div><div><a href="#">Cargo</a></div></li>
            <li class="pl-10 py-3 hover:bg-red-800 font-bold flex flex-row"><div class="px-5"><i class="fa-solid fa-user-gear"></i></div><div><a href="#">Empleado</a></div></li>
